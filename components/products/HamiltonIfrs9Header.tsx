...
export default function HamiltonIfrs9Header() {
  return (
    <section className="relative overflow-hidden bg-brand-dark">
      <ProductHeroImage
        src="/assets/hero/financial-instruments-hero-image.jpg"
        alt="Calculator and financial charts representing classification and measurement of financial instruments under IFRS 9"
      />
      ...
      <ProductHeroMobileImage src="/assets/hero/financial-instruments-hero-image.jpg" />
    </section>
  );
}
