...
export default function IdealWealthFundsHeader() {
  return (
    <section className="relative overflow-hidden bg-brand-dark">
      <div className="absolute inset-0 hidden lg:block">
        <Image
          src="/assets/hero/ideal-wealth-funds-hero-image.png"
          alt="Laptop displaying the iDeal Wealth and Fund Management platform"
          fill
          sizes="100vw"
