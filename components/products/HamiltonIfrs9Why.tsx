...
const reasons: Reason[] = [
  {
    title: "Reduced Manual Interpretation",
    description:
  ...
  {
    title: "Auditable Link to Results",
    description: "Preserves an auditable link from contractual terms to accounting results.",
  },
  {
...
export default function HamiltonIfrs9Why() {
  return (
