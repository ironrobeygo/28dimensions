...
export default function HamiltonIfrs15Header() {
  return (
    <section className="relative overflow-hidden bg-brand-dark">
      <ProductHeroImage
        src="/assets/hero/revenue-recognition-hero-image.jpg"
        alt="Stacked coins and banknotes representing revenue recognition under IFRS 15"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-4 pt-20 pb-16 sm:px-6 sm:pt-24 sm:pb-20 lg:px-8 lg:pt-28 lg:pb-24">
        <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs font-medium text-white/50">
          ...
          <ChevronRight size={12} />
          <span className="text-white/70">IFRS 15</span>
        </nav>
        ...
        <div className="mt-8 max-w-2xl">
          ...
          <p className="mt-4 text-sm text-white/60">
            IFRS 15 introduces a single principles-based model for reporting the nature, amount,
            timing and uncertainty of revenue and cash flows from customer contracts.
            Hamilton&apos;s Contract Economics Modeling decomposes contracts into performance
            obligations and transaction-price allocation to produce consistent revenue outcomes
            at scale.
          </p>
      ...
      <ProductHeroMobileImage src="/assets/hero/revenue-recognition-hero-image.jpg" />
    </section>
  );
}
